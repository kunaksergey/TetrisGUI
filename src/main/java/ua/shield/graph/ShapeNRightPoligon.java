 ...
 * Фигура N(правая)
 */
public class ShapeNRightPoligon extends Shape implements ITurn90{

	public ShapeNRightPoligon(double X0,double Y0, Color color){ //X0:Y0 -координаты вращения
		super(X0,Y0,color);
